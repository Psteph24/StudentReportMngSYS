...
int main()
{
	...
	do
	{
		...
		case '6':cout << "Exitting, thank you! "; exit(0);
		}
	} while (ch != '6');
	return 0;
}
...
//modify record for special roll nr
...
//delete record with particular roll nr 
void delete_student(int n)
{
	...
	if (!iFile)
	{
		cout << "File coult not be opened.. Press any Key to exit...";
		cin.ignore();
		cin.get();
		return;
	}
